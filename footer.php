	...
	<div class="footer">
		<div class="container">
			...
			<div class="col-md-4 w3_footer_grid">
				...
				<ul class="w3_footer_grid_list1">
                    ...
                    <ul class="phone_email">
                        <li><i class="fa fa-phone" aria-hidden="true"></i> <a href="tel:+919798344747">(+91) 9798344747</a></li>
			...
			<div class="wthree_footer_copy">
				<p>© <?=date('Y')?> Grocery Store. All rights reserved | Design by <a href="http://w3layouts.com/">Avishek</a></p>
			</div>
		</div>
</div>
<!-- //footer -->
