                        ...
                        <ul class="slides">
                            <li>
                                <div class="w3l_banner_nav_right_banner">
                                    <h3>Book your <span>room</span> with you choice.</h3>
                                    <div class="more">
                                        <a href="products.php" class="button--saqui button--round-l button--text-thick" data-text="Shop now">room now</a>
                                    </div>
                                </div>
                            </li>
                            <li>
                                <div class="w3l_banner_nav_right_banner1">
                                    <h3>Book your <span>room</span> with your choice.</h3>
                                    <div class="more">
                                        <a href="products.php" class="button--saqui button--round-l button--text-thick" data-text="Shop now">room  now</a>
                                    </div>
                                </div>
