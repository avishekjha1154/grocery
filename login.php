				...
				<div class="module form-module">
                    ...
                    <div class="form">
                        ...
                        <form action="" method="post">
                            ...
                            <input type="text" name="City" placeholder="City" required value="samalkha" readonly style="text-align:center">
                            <input type="radio" name="Gn" placeholder="" required>Male
                            <input type="radio" name="Gn" placeholder="" required>Female

                            <input type="text" name="Username" placeholder="Username" required>
                            <input type="password" name="Password" placeholder="Password" required pattern=".{4,}" title="password must be 4 charecter">
